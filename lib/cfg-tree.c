      ...
      if (current_pipe_name != NULL)
        {
          if (g_hash_table_contains(pipe_persist_names, current_pipe_name))
            {
              msg_error("Error checking the uniqueness of the persist names, please override it with persist-name option. Shutting down.",
            ...
            {
              g_hash_table_add(pipe_persist_names, current_pipe_name);
            }
        }
    }
