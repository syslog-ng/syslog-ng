...
log_msg_global_init(void)
{
  ...
  stats_lock();
  stats_register_counter(0, stats_components_get_component_index(SCS_GLOBAL), "msg_clones", NULL, SC_TYPE_PROCESSED,
                         &count_msg_clones);
  stats_register_counter(0, stats_components_get_component_index(SCS_GLOBAL), "payload_reallocs", NULL, SC_TYPE_PROCESSED,
                         &count_payload_reallocs);
  stats_register_counter(0, stats_components_get_component_index(SCS_GLOBAL), "sdata_updates", NULL, SC_TYPE_PROCESSED,
                         &count_sdata_updates);
  stats_unlock();
}
