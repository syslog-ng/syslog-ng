  ...
  if (stats_check_level(2))
    {
      ...
      stats_register_and_increment_dynamic_counter(2, stats_components_get_component_index("host") | SCS_SOURCE, NULL, log_msg_get_value(msg, LM_V_HOST, NULL),
                                                   msg->timestamps[LM_TS_RECVD].tv_sec);
      if (stats_check_level(3))
        {
          stats_register_and_increment_dynamic_counter(3, stats_components_get_component_index("sender") | SCS_SOURCE, NULL, log_msg_get_value(msg, LM_V_HOST_FROM,
                                                       NULL), msg->timestamps[LM_TS_RECVD].tv_sec);
          stats_register_and_increment_dynamic_counter(3, stats_components_get_component_index("program") | SCS_SOURCE, NULL, log_msg_get_value(msg, LM_V_PROGRAM,
                                                       NULL), msg->timestamps[LM_TS_RECVD].tv_sec);
        }
