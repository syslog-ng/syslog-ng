...
log_src_driver_init_method(LogPipe *s)
{
  ...
  stats_lock();
  stats_register_counter(0, SCS_SOURCE | stats_components_get_component_index("group"), self->super.group, NULL, SC_TYPE_PROCESSED,
                         &self->super.processed_group_messages);
  stats_register_counter(0, stats_components_get_component_index("center"), NULL, "received", SC_TYPE_PROCESSED, &self->received_global_messages);
  stats_unlock();
...
log_src_driver_deinit_method(LogPipe *s)
{
  ...
  stats_lock();
  stats_unregister_counter(SCS_SOURCE | stats_components_get_component_index("group"), self->super.group, NULL, SC_TYPE_PROCESSED,
                           &self->super.processed_group_messages);
  stats_unregister_counter(stats_components_get_component_index("center"), NULL, "received", SC_TYPE_PROCESSED, &self->received_global_messages);
  stats_unlock();
  return TRUE;
}
...
log_dest_driver_init_method(LogPipe *s)
{
  ...
  stats_lock();
  stats_register_counter(0, SCS_DESTINATION | stats_components_get_component_index("group"), self->super.group, NULL, SC_TYPE_PROCESSED,
                         &self->super.processed_group_messages);
  stats_register_counter(0, stats_components_get_component_index("center"), NULL, "queued", SC_TYPE_PROCESSED, &self->queued_global_messages);
  stats_unlock();
...
log_dest_driver_deinit_method(LogPipe *s)
{
  ...
  stats_lock();
  stats_unregister_counter(SCS_DESTINATION | stats_components_get_component_index("group"), self->super.group, NULL, SC_TYPE_PROCESSED,
                           &self->super.processed_group_messages);
  stats_unregister_counter(stats_components_get_component_index("center"), NULL, "queued", SC_TYPE_PROCESSED, &self->queued_global_messages);
  stats_unlock();
