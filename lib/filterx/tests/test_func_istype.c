...
{
  cr_assert_not(filterx_function_istype_new("istype", NULL));
}
...
Test(filterx_func_istype, null_object_arg)
{
  ...
  cr_assert_not(filterx_function_istype_new("istype", args));
}
...
Test(filterx_func_istype, non_matching_type)
{
  ...
  FilterXFunction *func_expr = filterx_function_istype_new("istype", args);
  cr_assert(func_expr);
