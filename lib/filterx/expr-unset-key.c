...
#include "filterx/expr-unset-key.h"
#include "filterx/object-primitive.h"

typedef struct _FilterXUnsetKey
{
  FilterXExpr super;
  FilterXExpr *operand;
  FilterXExpr *key;
...
_eval(FilterXExpr *s)
{
  FilterXUnsetKey *self = (FilterXUnsetKey *) s;
...
FilterXExpr *
filterx_unset_key_new(FilterXExpr *operand, FilterXExpr *key)
{
  FilterXUnsetKey *self = g_new0(FilterXUnsetKey, 1);
