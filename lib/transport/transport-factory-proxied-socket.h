...
#ifndef TRANSPORT_FACTORY_PROXIED_SOCKET_H_INCLUDED
...
struct _TransportFactoryProxiedSocket
{
  TransportFactory super;
};

TransportFactory *transport_factory_proxied_socket_new(gint sock_type);

const TransportFactoryId *transport_factory_proxied_socket_id(void);
