...
Test(value_pairs, test_transformers)
{
  ...
  transformers_testcase("everything", NULL,
                        ...
                        "PEERIP,PEERPORT,PID,PRI,PRIORITY,PROGRAM,PROTO,P_AMPM,P_DATE,P_DAY,P_FULLDATE,"
                        ...
                        "R_YEAR_DAY,SDATA,SEC,SEQNUM,SEVERITY,SEVERITY_NUM,SOURCEIP,SOURCEPORT,STAMP,SYSUPTIME,S_AMPM,S_DATE,"
