...
/* Error code for command parsing failure
 * This is a `unique` (yes, no guarantiecurrently) negative number to avoid conflict with the return values of the main functions. */
#define ERR_CMD_PARSING_FAILED -11111
