...
void afamqp_dd_set_ssl_cacrt(LogDriver *d, const gchar *cacrt);
void afamqp_dd_set_ssl_key(LogDriver *d, const gchar *key);
void afamqp_dd_set_ssl_usercrt(LogDriver *d, const gchar *usercrt);
