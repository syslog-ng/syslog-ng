...
{
  return listener_name ? afsocket_sd_format_listener_name : afsocket_sd_format_connections_name;
}
                          ...
                          GlobalConfig *cfg)
{
  ...
  self->super.super.super.generate_persist_id = afsocket_sd_format_name;
