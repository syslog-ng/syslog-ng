...
static CfgLexerKeyword darwinosl_keywords[] =
{
  ...
  { "reset_bookmark_on_filter_predicate_change", KW_RESET_BOOKMARK_ON_FILTER_PREDICATE_CHANGE },
  { "start_from_now",         KW_START_FROM_NOW },
  { "always_start_from_now",  KW_ALWAYS_START_FROM_NOW },
  { "do_not_use_bookmark",    KW_DO_NOT_USE_BOOKMARK },
  { "go_reverse",             KW_GO_REVERSE },
  { "fetcher_reopen_delay",   KW_LOG_FETCH_REOPEN_DELAY },
