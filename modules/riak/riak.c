...
riak_worker_insert(LogThrDestDriver *s, LogMessage *msg)
{
  ...
  msg_debug("RIAK key sent", evt_tag_str("driver", self->super.super.super.id),
            evt_tag_str("key", result->str), NULL);
  log_template_format(self->value, msg, &self->template_options, LTZ_SEND, self->super.seq_num,
                      NULL, result);

  msg_debug("RIAK value sent", evt_tag_str("driver", self->super.super.super.id),
            evt_tag_str("value", result->str), NULL);
  ...
  msg_debug("RIAK bucket sent", evt_tag_str("driver", self->super.super.super.id),
            evt_tag_str("bucket", result->str), NULL);
