...
%{__install} -p -m 644 rpm/syslog-ng.conf %{buildroot}%{_sysconfdir}/%{name}/syslog-ng.conf

%{__install} -d -m 755 %{buildroot}%{_sysconfdir}/logrotate.d
%{__install} -p -m 644 rpm/syslog-ng.logrotate %{buildroot}%{_sysconfdir}/logrotate.d/syslog
...
patch -f  --directory %{buildroot}%{_unitdir} -p3 < `pwd`/rpm/syslog-ng-rhel-systemd-kludge.patch
