                  ...
                  char * szAccount, char * szPassword, BOOL bInteractive)
{
  ...
  if (hSCManager == NULL)
    {
      fprintf(stderr,"Install() : SCManager == NULL : Error = 0x%08x\n", GetLastError());
      return 1;
    }
  ...
  if (hService == NULL)
    {
      fprintf(stderr,"Install() : hService == NULL : Error = 0x%08x\n", GetLastError());
  ...
  if (ChangeServiceConfig2(hService, SERVICE_CONFIG_DESCRIPTION, &description) == FALSE)
    {
      fprintf(stderr,"Install() : Service description : Error = 0x%08x\n", GetLastError());
    }
...
uninstall_service(char * szName)
{
  ...
  if (hSCManager == NULL)
    {
      fprintf(stderr,"Uninstall() : SCManager == NULL : Error = 0x%08x\n", GetLastError());
      return 1;
    }
  ...
  if (hService == NULL)
    {
      fprintf(stderr,"Uninstall() : hService == NULL : Error = 0x%08x\n", GetLastError());
      CloseServiceHandle(hSCManager);
      return 1;
    }
  ...
  if (DeleteService(hService) == FALSE)
    {
      fprintf(stderr,"Uninstall() : Error = 0x%08x\n", GetLastError());
      CloseServiceHandle(hService);
      CloseServiceHandle(hSCManager);
      return 1;
    }
...
start_service_by_name(char * szName)
{
  ...
  if (hSCManager == NULL)
    {
      fprintf(stderr,"Start() : SCManager == NULL : Error = 0x%08x\n", GetLastError());
      return 1;
    }
  ...
  if (hService == NULL)
    {
      fprintf(stderr,"Start() : hService == NULL : Error = 0x%08x\n", GetLastError());
      CloseServiceHandle(hSCManager);
      return 1;
    }
  ...
  if (StartService(hService,0,NULL) == FALSE)
    {
      fprintf(stderr,"Start() : Error = 0x%08x\n", GetLastError());
      CloseServiceHandle(hService);
      CloseServiceHandle(hSCManager);
      return 1;
    }
...
stop_service_by_name(char * szName)
{
  ...
  if (hSCManager == NULL)
    {
      fprintf(stderr,"Stop() : SCManager == NULL : Error = 0x%08x\n", GetLastError());
      return 1;
    }
  ...
  if (hService == NULL)
    {
      fprintf(stderr,"Stop() : hService == NULL : Error = 0x%08x\n", GetLastError());
      CloseServiceHandle(hSCManager);
      return 1;
    }
  ...
  if (ControlService(hService, SERVICE_CONTROL_STOP, &Status) == FALSE)
    {
      fprintf(stderr,"Stop() : Error = 0x%08x\n", GetLastError());
      CloseServiceHandle(hService);
      CloseServiceHandle(hSCManager);
      return 1;
    }
