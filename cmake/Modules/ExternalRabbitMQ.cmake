...
if (EXISTS ${PROJECT_SOURCE_DIR}/modules/afamqp/rabbitmq-c/librabbitmq/amqp.h)
    ...
    set(${LIB_NAME}_INTERNAL_LIBRARY "${PROJECT_BINARY_DIR}/lib/librabbitmq${CMAKE_SHARED_LIBRARY_SUFFIX}")
    install(DIRECTORY ${PROJECT_BINARY_DIR}/lib/ DESTINATION lib USE_SOURCE_PERMISSIONS FILES_MATCHING PATTERN "librabbitmq${CMAKE_SHARED_LIBRARY_SUFFIX}*")
