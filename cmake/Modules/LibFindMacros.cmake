...
function (libfind_pkg_detect PREFIX)
  ...
  foreach (i ${ARGN})
    ...
    elseif ("${i}" STREQUAL "PATH_HINT")
      set (argname pathhint)
    elseif ("${i}" STREQUAL "FIND_LIBRARY")
      set(argname libraryargs)
    elseif ("${i}" STREQUAL "LIBRARY_HINT")
      set (argname libraryhint)
    else()
  ...
  if (pathargs)
    find_path (${PREFIX}_INCLUDE_DIR NAMES ${pathargs} HINTS ${pathhint} ${${PREFIX}_PKGCONF_INCLUDE_DIRS})
  endif()
  if (libraryargs)
    find_library(${PREFIX}_LIBRARY NAMES ${libraryargs} HINTS ${libraryhint} ${${PREFIX}_PKGCONF_LIBRARY_DIRS})
  endif()
endfunction()
